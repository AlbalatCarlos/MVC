                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6"> <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu btn btn-block"  >
                                                    <li><a style="color:#337ab7;" class="btn btn-block btn-default" href="./MenuGestionPeliculas?dir=alta">Alta Pelicula</a></li>
                                                    <li><a style="color:#337ab7;" class="btn  btn-block btn-default" href="./MenuGestionPeliculas?dir=mod">Modificar Pelicula</a></li>
                                                    <li><a style="color:#337ab7;" class="btn  btn-block btn-default" href="./MenuGestionPeliculas?dir=bor">Borrar Pelicula</a></li>
                                                </ul>
                                            </div> </div>
