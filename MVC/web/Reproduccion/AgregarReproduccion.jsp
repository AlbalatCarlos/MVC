    ...
    <body>
        ...
        <form class="form-group col-xs-6 col-xs-offset-3" action="/MVC/AltaReproduccion" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-xs-4"><a href="/MVC/MenuGestionPeliculas" class="button btn btn-primary btn-md">Volver a menu </a></div>
                <div class="col-xs-4 col-xs-offset-2"><input class="button btn btn-success btn-block" type="submit" value="Alta Reproduccion"/></div>
